<%-- 
    Document   : e-tickets
    Created on : 13-Jan-2023, 14:19:00
    Author     : dulan
--%>
...
<body>
  <header id="site-header" class="w3l-header fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fill px-lg-0 py-0 px-3">
      <div class="container">
        <h1><a class="navbar-brand" href="home.jsp"><span aria-hidden="true"></span>
            ABC Movies </a></h1>
        ...
        <div class="px-0 pt-4 pb-0 mt-3 mb-3">
          <form id="form">
            <ul id="progressbar" class="progressbar-class">
              ...
              <li id="step3" class="not_active">Checkout</li>
            ...
            <fieldset>
              ...
              <div>
                <iframe id="seat-sel-iframe"
                  ...
                  src="seats.jsp"></iframe>
              </div>
              <br>
              <input type="button" name="next-step" class="next-step" value="Continue to checkout" />
            ...
            <fieldset>
                ...
                <div class="payment-row">
                  <div class="col-75">
                    <div class="payment-container">
                      <div class="payment-row">
                        <div class="col-50">
                          <h3 id="payment-h3">Checkout Form</h3>
                            ...
                            <div class="col-50 payment">
                              <label for="card" class="method card">
                                ...
                                <div class="radio-input">
                                  ...
                                  Pay RS.500.00 with credit card
                                </div>
                              </label>
                            </div>
                            <div class="col-50 payment">
                              <label for="paypal" class="method paypal">
                                ...
                                <div class="radio-input">
                                  ...
                                  Pay $3.00 with PayPal
                                </div>
                              </label>
                            </div>
                          </div>

                          <div class="payment-row" style="isibility: hidden">
                            <div class="col-50">
                              <label for="cname">First Name</label>
                              <input type="text" id="cname" name="cardname" placeholder="First name"  />
                            </div>
                            <div class="col-50">
                              <label for="ccnum">Last Name</label>
                              <input type="text" id="ccnum" name="cardnumber" placeholder="Last name"
                                 />
                            </div>
                          </div>
                          <div class="payment-row">
                            <div class="col-50">
                              <label for="expmonth">E mail address</label>
                              <input type="text" id="expmonth" name="expmonth" placeholder="@gmail.com"  />
                            </div>
                            <div class="col-50">
                              <div class="payment-row">
                                <div class="col-50">
                                  <label for="expyear">Mobile number</label>
                                  <input type="text" id="expyear" name="expyear" placeholder="+94"  />
                                </div>
                                <div class="col-50">
                                  <label for="cvv">ID number</label>
              ...
              <input type="button" name="previous-step" class="cancel-pay-btn" value="continue to Payment"
